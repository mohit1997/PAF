...
# feature_gen = PolynomialFeatures(7, include_bias=True)
...
def linearnet(features):
  ...
  x = Dense(128, kernel_regularizer=regularizers.l2(0.1), activation='relu')(x)
  x = BatchNormalization()(x)
  x = Dense(64, kernel_regularizer=regularizers.l1(0.1), activation='relu')(x)
  x = BatchNormalization()(x)
  x = Dense(1)(x)
