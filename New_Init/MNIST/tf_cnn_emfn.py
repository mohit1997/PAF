...
def deepnn(x):
  ...
  with tf.name_scope('conv1'):
    ...
    # h_conv1 = emfn(temp_1, k1=4, k2=4, scale=None) #emfn
    # h_conv1 = taylor(temp_1, k=4, scale=None) #taylor
  ...
  with tf.name_scope('conv2'):
    ...
    # h_conv2 = emfn(temp_c2, k1=4, k2=4, scale=None) #emfn
    # h_conv2 = taylor(temp_c2, k=4, scale=None) #taylor
  ...
  with tf.name_scope('fc1'):
    ...
    # h_fc1 = emfn(h_fc, k1=4, k2=4, scale=None) #emfn
    # h_fc1 = taylor(h_fc, k=4, scale=None) #taylor
...
def main(_):
  ...
  with tf.name_scope('loss'):
    ...
    cross_entropy = tf.nn.softmax_cross_entropy_with_logits(labels=y_,
                                                            logits=y_conv)
  cross_entropy = tf.reduce_mean(cross_entropy) #+ reg_losses
  ...
  with tf.Session() as sess:
    ...
    np.save('testing_score_emfn', np.array(acc))
