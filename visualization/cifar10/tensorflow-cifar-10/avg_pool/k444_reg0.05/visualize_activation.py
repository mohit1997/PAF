...
num = 3
at_path = 'conv2/Ac/' + str(num) + '/activation_attention:0.npy'
ker_path = 'conv2/Ac/' + str(num) + '/activation_weights:0.npy'
bias_path = 'conv2/Ac/' + str(num) + '/activation_bias:0.npy'
mean_path = 'conv2/Ac/' + str(num) + '/activation_means:0.npy'
var_path = 'conv2/Ac/' + str(num) + '/activation_variances:0.npy'
