...
num = 2
at_path = 'conv1/Ac/' + str(num) + '/activation_attention:0.npy'
ker_path = 'conv1/Ac/' + str(num) + '/activation_weights:0.npy'
bias_path = 'conv1/Ac/' + str(num) + '/activation_bias:0.npy'
mean_path = 'conv1/Ac/' + str(num) + '/activation_means:0.npy'
var_path = 'conv1/Ac/' + str(num) + '/activation_variances:0.npy'
...
fig.suptitle('Activation Plots for Taylor with k={:d} num={:d}'.format(k, num))
fig.tight_layout()
fig.subplots_adjust(top=0.92)
plt.savefig("Activations_k={:d}_num={:d}.png".format(k, num))
plt.show()
